...
netsh interface ipv4 set address "!adapter[%choice%]:~0,-1!" static %Input1% %Input3% && echo ############# "!adapter[%choice%]!" is changed IP now (%Input1%) ########### || echo ############# "!adapter[%choice%]!" failed to change ###########
