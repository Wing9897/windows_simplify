...
set /p Input1=Type DNS IP :

netsh interface ipv4 set dns !adapter[%choice%]! static %Input1%  && echo ############# !adapter[%choice%]! is changed DNS now (%Input1%) ###########  || echo ############# !adapter[%choice%]! failed to change ###########
