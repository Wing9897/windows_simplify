...
set /p Input5=Type DNS IP :
netsh interface ipv4 set address !adapter[%choice%]! static %Input1% %Input3% %Input4% && echo ############# !adapter[%choice%]! is changed IP now (%Input1%) ###########  || echo ############# !adapter[%choice%]! failed to change ###########
netsh interface ipv4 set dns !adapter[%choice%]! static %Input5%  && echo ############# !adapter[%choice%]! is changed DNS now (%Input1%) ###########  || echo ############# !adapter[%choice%]! failed to change ###########
